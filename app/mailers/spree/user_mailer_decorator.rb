Spree::UserMailer.class_eval do
  ...
  def reset_password_instructions(user, token, _opts = {})
    ...
    mail_template(user, :reset_password_instructions, category: :account, edit_password_reset_url: edit_password_reset_url)
  end
  ...
  def confirmation_instructions(user, token, _opts = {})
    ...
    mail_template(user, template, category: :account, confirmation_url: confirmation_url)
  end
end
