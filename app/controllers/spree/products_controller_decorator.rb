module Spree
  module ProductsControllerDecorator
    ...
    def show
      ...
      @buy_box_variant = @product.variants.find_best_price_in_option.first || @product.variants.find_best_price_in_option(in_stock: false).first
    ...
    def similar_variants
      ...
      return redirect_to(@product) if @variation.present? && !@product.variations.include?(@variation)
