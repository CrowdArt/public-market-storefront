...
ActiveRecord::Schema.define(version: 2018_08_20_141838) do
  ...
  create_table "spree_credit_cards", id: :serial, force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_spree_credit_cards_on_slug"
  ...
  create_table "spree_product_collection_products", force: :cascade do |t|
    t.bigint "product_id"
    t.bigint "product_collection_id"
    t.index ["product_collection_id"], name: "idx_spree_prod_collection_on_prod_collection_id"
    t.index ["product_id", "product_collection_id"], name: "idx_spree_prod_collection_prods_on_prod_and_prod_collection", unique: true
    t.index ["product_id"], name: "index_spree_product_collection_products_on_product_id"
  end
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.index ["number"], name: "index_spree_products_on_number", unique: true
  ...
  create_table "spree_upload_errors", force: :cascade do |t|
    t.bigint "upload_id"
    t.string "message"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["upload_id"], name: "index_spree_upload_errors_on_upload_id"
  end
  ...
  create_table "spree_users", id: :serial, force: :cascade do |t|
    ...
    t.index ["login"], name: "index_spree_users_on_login", unique: true
