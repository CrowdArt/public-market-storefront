...
class AddMissingIndexesOnSpreeTables < ActiveRecord::Migration[4.2]
  def change
    ...
    add_index :spree_orders, :canceler_id unless index_exists? :spree_orders, :canceler_id

    add_index :spree_orders, :store_id unless index_exists? :spree_orders, :store_id
